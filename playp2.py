...
def play_game():
    ...
    # Define the valid octagon shape
    # The 'extras' logic from your original code to set valid 0 squares
    ...
    while True:
        ...
        if not legal_moves and not get_legal_moves(board, 3-turn):
            ...
            if p1_score > p2_score: print("You Win!")
            elif p2_score > p1_score: print("Bot Wins!")
            else: print("Draw!")
            break
